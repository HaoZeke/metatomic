...
from metatomic.ase._calculator import (
    MetatomicCalculator,
...
def test_rotate_atoms_preserves_geometry(tmp_path):
    ...
    from metatomic.ase._calculator import _rotate_atoms
...
def test_choose_quadrature_rules():
    ...
    from metatomic.ase._calculator import _choose_quadrature
...
def test_get_quadrature_properties():
    ...
    from metatomic.ase._calculator import _get_quadrature
...
def test_compute_rotational_average_identity():
    ...
    from metatomic.ase._calculator import _compute_rotational_average
